...
export default function TournamentCard({
  ...
  const handleClick = () => {
    router.push(`/tournaments/${id}`); // Redirige a la página del torneo usando su ID
  };
  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardFooter className="p-4 pt-0">
        <Button className="w-full" onClick={handleClick}>Ver detalles</Button> {/* Agregar la lógica de redirección aquí */}
      </CardFooter>
    </Card>
  )
}
