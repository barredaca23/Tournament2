...
import { register, login, getUsers, updateUser, deleteUser, getUserProfile, getTournamentsByUserId } from '../controllers/userController.js';
...
router.get('/:userId', getTournamentsByUserId)
